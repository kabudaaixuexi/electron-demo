<template>
    ...
    <section :ref="MenuDom" :style="{ 'backgroundImage':'url(' + deskBackground + ')' }" class="desk_container" v-if="isReset" >
...
.desk_container {
    ...
    z-index: 0;
    position: relative;
    background: url(var(--background, '@renderer/assets/desk/_desk.jpeg')) auto 100%;
    &::after {
        content: "";
        top: 0;
        left: 0;
