...
export default defineComponent({
  ...
  setup() {
    ...
    const sendNew = () => {
      ...
      state.newInput = ''
      console.log(document.getElementsByClassName('specific_con')[0]);
      document.getElementsByClassName('specific_con')[0].scrollTop = document.getElementsByClassName('specific_con')[0].scrollHeight + 1000
      console.log(document.getElementsByClassName('specific_con')[0].scrollTop);
      console.log(document.getElementsByClassName('specific_con')[0].scrollHeight);
    }
